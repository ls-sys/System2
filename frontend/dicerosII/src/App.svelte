...
<main>
	...
	<figure>
		<img src="diceros.jpg" alt="diceros">
		<figcaption>{name}</figcaption>
	</figure>
	
	<form action="https://diceros.ls-sys.com">
		<div>
		...
		<div>
			...
			<input type="password" id="passphrase" placeholder="Contraseña">
		</div>
		<div>
...
<style>
	...
	form div input:not([type='submit'])::placeholder {
		color: #4188ce;
	}
